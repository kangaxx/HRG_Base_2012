...
namespace HRG_BaseLibrary_2012
{
    public class HRG_ExcelHelper
    {
        ...
        /// </summary>
        public HRG_ExcelHelper()
        {
            ///
            /// to-do list excel列表文件
            /// 
        ...
        public static OleDbConnection CreateConnection(string ExcelFilePath, ExcelVerion Verion = ExcelVerion.Excel2007)
        {
